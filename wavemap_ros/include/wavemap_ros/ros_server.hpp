#ifndef WAVEMAP_ROS_ROS_SERVER_HPP
#define WAVEMAP_ROS_ROS_SERVER_HPP
...
/**
 * Config struct for the ROS server.
 */
...
/**
 * ROS server node for running the WaveMap pipeline.
 */
class RosServer : public rclcpp::Node {
 public:
    RosServer(rclcpp::Node::SharedPtr nh, rclcpp::Node::SharedPtr nh_private);
    RosServer(rclcpp::Node::SharedPtr nh, rclcpp::Node::SharedPtr nh_private, const RosServerConfig& config);
  ...
  RosInputBase* addInput(const param::Value& integrator_params,
                         const rclcpp::Node::SharedPtr& nh, rclcpp::Node::SharedPtr nh_private);
...
void advertiseServices(rclcpp::Node::SharedPtr nh_private);
...
rclcpp::Service<wavemap_msgs::srv::FilePath>::SharedPtr load_map_srv_;
  ...
  bool resetMapCallback(const std::shared_ptr<std_srvs::srv::Trigger::Request> request,
                        std::shared_ptr<std_srvs::srv::Trigger::Response> response);
  bool saveMapCallback(const std::shared_ptr<wavemap_msgs::srv::FilePath::Request> request,
                       std::shared_ptr<wavemap_msgs::srv::FilePath::Response> response);
  bool loadMapCallback(const std::shared_ptr<wavemap_msgs::srv::FilePath::Request> request,
                       std::shared_ptr<wavemap_msgs::srv::FilePath::Response> response);
};

}  // namespace wavemap

#endif  // WAVEMAP_ROS_ROS_SERVER_HPP